...
public class SmfgBreServiceTest {
    ...
    public void invokeBreFlow_Success() throws Exception {
        ...
        lendingShopDocuments.setApplicationId(null);


        doReturn(123D).when(uploadDocumentService).calculateShopInferredDistance(anyString(),anyString(),anyLong());
        doReturn("20068").when(smfgConfig).getCurrentAddressType();
        doReturn("20069").when(smfgConfig).getPermanentAddressType();
        doReturn(lendingShopDocuments).when(lendingShopDocumentsDao).findTop1ByMerchantIdAndApplicationIdAndProofTypeOrderByIdDesc(anyLong(),anyLong(),anyString());
    ...
    @Test
    public void invokeBreFlow_SuccessAddressLT120() throws Exception {
        setup();
        LendingApplication lendingApplication = new LendingApplication();
        lendingApplication.setId(5756732L);
        lendingApplication.setMerchantId(20000404L);
        ...
        cKycResponseDto.setDob("07/10/1999");
        cKycResponseDto.setMobile("9350XXXXXX");
        cKycResponseDto.setAddress("Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Haryana 136119");
        cKycResponseDto.setAadharNumber("123456789");
        cKycResponseDto.setSelfieAadhaarFaceMatchPer(90D);
        cKycResponseDto.setSelfieLivelinessScore(0.9D);
        cKycResponseDto.setBankBenePanNameMatchPer(0.7D);
    ...
    @Test
    public void invokeBreFlow_SuccessAddressLT180() throws Exception {
        setup();
        LendingApplication lendingApplication = new LendingApplication();
        lendingApplication.setId(5756732L);
        lendingApplication.setMerchantId(20000404L);
        ...
        cKycResponseDto.setDob("07/10/1999");
        cKycResponseDto.setMobile("9350XXXXXX");
        cKycResponseDto.setAddress("Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Haryana 136119");
        cKycResponseDto.setAadharNumber("123456789");
        cKycResponseDto.setSelfieAadhaarFaceMatchPer(90D);
        cKycResponseDto.setSelfieLivelinessScore(0.9D);
        cKycResponseDto.setBankBenePanNameMatchPer(0.7D);
    ...
    @Test
    public void invokeBreFlow_SuccessAddressGT180() throws Exception {
        setup();
        LendingApplication lendingApplication = new LendingApplication();
        lendingApplication.setId(5756732L);
        lendingApplication.setMerchantId(20000404L);
        ...
        cKycResponseDto.setDob("07/10/1999");
        cKycResponseDto.setMobile("9350XXXXXX");
        cKycResponseDto.setAddress("Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Khizarpura Kamoda Kurukshetra Haryana 136119");
        cKycResponseDto.setAadharNumber("123456789");
        cKycResponseDto.setSelfieAadhaarFaceMatchPer(90D);
        cKycResponseDto.setSelfieLivelinessScore(0.9D);
        cKycResponseDto.setBankBenePanNameMatchPer(0.7D);
    ...
    public void invokeBreFlow_SelfieMatchFailure() throws Exception {
        ...
        LendingShopDocuments lendingShopDocuments = new LendingShopDocuments();
        lendingShopDocuments.setApplicationId(123L);
        doReturn(lendingShopDocuments).when(lendingShopDocumentsDao).findTop1ByMerchantIdAndApplicationIdAndProofTypeOrderByIdDesc(anyLong(),anyLong(),anyString());
        doReturn("20068").when(smfgConfig).getCurrentAddressType();
        doReturn("20069").when(smfgConfig).getPermanentAddressType();
        doReturn(nbfcResponseDTO).when(lenderAPIGateway).invokeStage(ArgumentMatchers.any(NBFCRequestDTO.class), eq(LenderAssociationStages.BRE));

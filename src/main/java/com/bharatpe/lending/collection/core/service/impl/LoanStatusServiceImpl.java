...
public class LoanStatusServiceImpl implements LoanStatusService {
    ...
    public void processLoanClosure(LoanClosureDTO loanClosureDTO) {
        ...
        loanClosureService.closeLoanAndUpdateLender(loanClosureDTO.getActiveLoan(),loanClosureDTO.getLendingLedger(),loanClosureDTO.getOrderId(), loanClosureDTO.isPostCharges(), loanClosureDTO.getChargeId());
    }

...
public class LoanPaymentUtil {
    ...
    private static final Set<String> NON_NPA_SUPPORTED_LENDER = new HashSet<>(Arrays.asList(LDC.name(), MAMTA.name(), HINDON.name(), LIQUILOANS.name(), LIQUILOANS_NBFC.name(), LIQUILOANS_P2P.name(), LIQUILOANS_P2P_OF.name(), MAMTA0.name(), MAMTA1.name(), MAMTA2.name(), PAYU.name(), SMFG.name(), PIRAMAL.name()));

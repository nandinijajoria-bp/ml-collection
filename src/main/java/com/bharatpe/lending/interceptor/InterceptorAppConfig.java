...
//	ExternalClientHmacInterceptor externalClientHmacInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(validateTokenInterceptor)
				...
				"/createAgreement/**","/support/createSanctionCumLoanAgreement/**","/lending/application/resubmit", "/support/nbfcRetry/**","/lending/getLatestLoanDetails", "/lending/pullPayment",
				"/lending/pullPayment/**", "/experian","/experian/update","/experian/insert", "/lending/application", "/lending/first_loan_status",
						...
						"/lending/merchant/application/data");
		...
		"/support/showBulkContacts","/lending/liquiloan/approveLoan", "/lending/liquiloan/postPayoutStatusUpdate", "/lending/credit_line/application_status_update",
				...
				"/lms/payment/details", "/lending/liquiloan/backdated/loan", "/topup/close","/support/rte-program","/lending/merchant/eligibility","/support/loan-flag-status", "/lending/check-delete-eligible", "/lending/payment/details/v2", "/lending/homepage/cards", "/milestone/rte-eligibility-check");

...
//	ExternalClientHmacInterceptor externalClientHmacInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(validateTokenInterceptor)
				.excludePathPatterns("/lending/merchant_loans","/support/fetchBulkContacts/**","/support/showBulkContacts","/lending/push_lead_response","/lending/csPanel/**",
		...
		registry.addInterceptor(commonInterceptor).addPathPatterns("/lending/due_amount","/lending/merchant_loans");

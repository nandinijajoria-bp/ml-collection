...
public abstract class ILenderGateway {
    ...
    public abstract NbfcResponseDto invokeStage(NbfcRequestDto nbfcRequestDto, LenderAssociationStages.PiramalAssociationStages piramalAssociationStages, int customRequestTimeout);

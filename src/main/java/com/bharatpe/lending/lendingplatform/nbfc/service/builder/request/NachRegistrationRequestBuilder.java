...
@Service
public class NachRegistrationRequestBuilder {
    @Autowired
    ...
    public NachRegistrationRequest buildRequest(LendingApplication lendingApplication) {
        ...
        return NachRegistrationRequest.builder()

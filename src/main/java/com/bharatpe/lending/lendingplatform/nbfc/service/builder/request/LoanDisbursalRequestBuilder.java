...
@Service
public class LoanDisbursalRequestBuilder {
    @Autowired
    ...
    @Autowired
    private LoanDocumentBuilder loanDocumentBuilder;
    @Autowired
    ...
    public LoanDisbursalRequest buildRequest(LendingApplication lendingApplication) {
        ...
        Map<DocType, LoanDocument> loanDocuments = loanDocumentBuilder.buildLoanDocuments(lendingApplication);
        ...
        return LoanDisbursalRequest.builder()

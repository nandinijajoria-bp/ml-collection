...
@Service
public class LoanSanctionRequestBuilder {
    @Autowired
    ...
    public LoanSanctionRequest buildRequest(LendingApplication lendingApplication) {
        ...
        return LoanSanctionRequest.builder()

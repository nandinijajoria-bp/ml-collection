...
public class SaveAddressProofDetailsController {
		...
		private Map<String, String> validateInput(CommonAPIRequest commonAPIRequest) {
			...
			if(addressProofDetails != null) {
				docNumber =  (addressProofDetails.get("doc_no") != null && !addressProofDetails.get("doc_no").isBlank()) ? addressProofDetails.get("doc_no") : null;
				fatherName =  (addressProofDetails.get("father_name") != null && !addressProofDetails.get("father_name").isBlank()) ? addressProofDetails.get("father_name") : null;
				personName =  (addressProofDetails.get("person_name") != null && !addressProofDetails.get("person_name").isBlank()) ? addressProofDetails.get("person_name") : null;
				dob =  (addressProofDetails.get("dob") != null && !addressProofDetails.get("dob").isBlank()) ? addressProofDetails.get("dob").toString() : null;
			}

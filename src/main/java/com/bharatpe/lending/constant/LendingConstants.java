...
public interface LendingConstants {
	...
	String ENACH_BANK_MESSAGE="<p className='inel-note'>Note: Your Bank A/C is not eNACH-able and our lending partners don’t process a loan application in this Bank A/C. Please change your Bank A/C by clicking <b>&lt;here&gt;</b> and try again.</p>";

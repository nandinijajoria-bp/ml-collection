...
public interface LendingConstants {
	...
	String DIGIO_PRESENTMENT_CANCEL_URL = "/transaction/digio-cancel";
	...
	String CANCEL_MANDATE_EXECUTION_URL = "/v2/client/mandate/execution/cancel";
  ...
  String GOLD_LOAN_DUE_URL = "/api/live-loan/due-amount?merchantId=";
	...
	String AUTO_PAY_SETTLEMENT = "AutoPaySettlement";
	...
	String NO_API_RESPONSE_MESSAGE="We are facing issues in your loan approval with {{lenderName}}. Attemp with another lender.";

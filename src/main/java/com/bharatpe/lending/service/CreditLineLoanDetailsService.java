        ...
        try {
            ...
            if (experian != null) {
                ...
                try {
                    ...
                    emailHandler.sendEmail(new ArrayList<String>() {{
                        add("khushal.virmani@bharatpe.com");
                    }}, "Eligible Loan Exception", "");
                }
...
//            if ("ORGANIZED".equalsIgnoreCase(basicDetailsDto.get().getCorrectMerchantType())) {

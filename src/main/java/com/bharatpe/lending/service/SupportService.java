...
//            }
            ...
            List<String> hindonEmails = Arrays.asList("rohit.dhola@bharatpe.com","sandeep.chauhan@bharatpe.com","anuj.puri@bharatpe.com","ashutosh.dhewal@bharatpe.com","kanika.sehgal@bharatpe.com","accounts@bharatpe.com","Helpdesk@mufinfinance.com","Rajat@mufinfinance.com","rajat.jain@bharatpe.com","anik.kansal@bharatpe.com","khushal.virmani@bharatpe.com");
            ...
            emailHandler.sendEmailWithAttachement("HINDON".equalsIgnoreCase(lender) ? hindonEmails : mamtaEmails, "AUTOMATED "+ lender +" NBFC Report "+new Date(), lender+" NBFC Cases Report For Date "+new Date() , bytes, lender+"_nbfc_details.csv", "text/csv");

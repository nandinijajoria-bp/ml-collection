	...
	public Map<String,Object> getDetails(Merchant merchant, Long applicationId,String category, String lender){
		...
		try {
			...
			if(lendingApplication != null){
				...
				data.put("location",merchant.getCity());
				data.put("shopNumber",merchant.getAddress());
				data.put("streetAddress","");
				data.put("landmark","");
				data.put("area","");
				data.put("pincode",merchant.getZipCode());
				data.put("city",merchant.getCity());
				data.put("state",merchant.getState());
				data.put("email",merchant.getEmail());
				data.put("createdAt",new SimpleDateFormat("dd-MMM-yyyy").format(new Date()));
				data.put("agreementAt",new SimpleDateFormat("dd-MMM-yyyy").format(new Date()));
				data.put("merchantName",merchant.getBeneficiaryName());
				data.put("payableDays",ediCount);
				data.put("businessCategory",merchant.getBusinessCategory());
				data.put("accountNumber",merchantBankDetail.getAccountNumber());
				data.put("accountType",merchantBankDetail.getAccType());
				data.put("ifsc",merchantBankDetail.getIfscCode());
				data.put("bankName",merchantBankDetail.getBankName());
				data.put("beneficiaryName",merchant.getBeneficiaryName());
				data.put("panNumber",experian.getPancardNumber());

...
public class CreditApplicationResponseDTO {
    ...
    private CreditApplicationResponseDTO.LoanApplication loanApplication;
    ...
    public CreditApplicationResponseDTO.LoanApplication getLoanApplication() {
        return loanApplication;
    }

    public void setLoanApplication(CreditApplicationResponseDTO.LoanApplication loanApplication) {

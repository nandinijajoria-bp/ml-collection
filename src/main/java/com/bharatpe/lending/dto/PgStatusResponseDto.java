...
@NoArgsConstructor
@Data
public class PgStatusResponseDto {
    ...
    public PgStatusResponseDto(String statusCode, String message) {
    ...
    public static class Data {
        ...
        public Map<String, Object> convertToMap() {
            return (Map<String, Object>) (new ObjectMapper()).convertValue(this, new TypeReference<Map<String, Object>>() {
            });
        }
